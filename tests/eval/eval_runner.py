...
# Add parent app directory and my-agent app directory to python path for robust resolution
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../app')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../my-agent/app')))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../my-agent/app')))
...
def main():
    ...
    if not os.path.exists(dataset_path):
        dataset_path = os.path.join(os.path.dirname(__file__), '../my-agent/tests/eval/datasets/eval-data-comprehensive.json')
